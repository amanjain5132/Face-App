...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\amanj\Desktop\face\Images_GUI\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\amanj\Desktop\face\Images_GUI\bg4.png")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\amanj\Desktop\face\Images_GUI\google.png")
        ...
        det_img_btn=Image.open(r"C:\Users\amanj\Desktop\face\Images_GUI\fb.png")
        ...
        # att_img_btn=Image.open(r"C:\Users\amanj\Desktop\face\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\amanj\Desktop\face\Images_GUI\gmail.png")
        ...
        bot_img_btn=Image.open(r"C:\Users\amanj\Desktop\face\Images_GUI\chatbot.jpg")
        bot_img_btn=bot_img_btn.resize((180,180),Image.LANCZOS)
        self.chat_img1=ImageTk.PhotoImage(bot_img_btn)

        chat_b1 = Button(bg_img,command=self.chat,image=self.chat_img1,cursor="hand2",)
        chat_b1.place(x=710,y=200,width=180,height=180)

        chat_b1_1 = Button(bg_img,command=self.chat,text="ChatBot",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        chat_b1_1.place(x=710,y=380,width=180,height=45)
