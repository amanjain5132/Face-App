...
# Testing Connection 
"""
conn = mysql.connector.connect(username='root', password='12345',host='localhost',database='fr')
cursor = conn.cursor()
...
class Student:
    ...
    # This part is image labels setting start 
        ...
        #update photo button
        update_photo_btn=Button(btn_frame,text="Update Pic",command=self.generate_dataset,width=9,font=("verdana",12,"bold"),fg="white",bg="navyblue")
